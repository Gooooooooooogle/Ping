...
<body>
	<jsp:useBean id="account" class="com.ping.domain.Account" scope="request" />
				...
				<div class="inset">
					<form:form method="post" modelAttribute="account" id="signup">
						<p>
            				...
            				<span><form:input path="username" id="username" name="username"/></span>
						</p>
						<p>
							<span><label for="password">密码</label></span>
            				<span><form:password path="password" id="password" name="password"/></span>
						</p>
						<p>
						...
						<p>
            				...
            				<span><form:input path="email" id="email" name="email"/></span>
						</p>
						<p>
							<label for="sex">性别：</label>
							<form:radiobutton path="sex" value="男"/>男
        					<form:radiobutton path="sex" value="女"/>女
        					<form:radiobutton path="sex" value="?"/>保密
						</p>
						<p>
